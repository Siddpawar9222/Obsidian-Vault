...
It is a Spring module that provides the <font color="#ffc000">RAD (Rapid Application Development)</font> feature to the Spring Framework. It is used to create a stand-alone Spring-based application that you can just run because it needs minimal Spring configuration.
